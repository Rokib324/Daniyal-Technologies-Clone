    ...
    <nav className="bg-white dark:bg-gray-900 shadow-lg fixed w-full top-0 z-50">
      ...
      <div className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden`}>
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white dark:bg-gray-900 shadow-lg">
          ...
          <button className="w-full text-left bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded-lg text-base font-medium transition-colors duration-200 mt-2">
            Contact Us
          </button>
        </div>
      </div>
